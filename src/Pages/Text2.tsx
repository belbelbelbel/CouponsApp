  ...
  return (
    <div className='bg-[#ecf7f8] w-screen py-[3.5rem]  text-black text'>
      <div className='flex py-[2rem] flex-col w-[91%] mx-auto  items-center relative -top-[0rem]'>
        <div className='w-[80vw] md:w-[40vw]  max-h-[40vh] flex rounded-[100%] bg-transparent' >
        ...
        <div className='flex flex-col relative  -top-[0rem] md:-top-[0rem] gap-[0.7rem] md:gap-[0.5rem]'>
          <div className='text-center  tracking-wide md:max-w-[35%]  max-w-[65%] mx-auto text-[5.5vw] md:text-[3vw] font-medium  md:leading-[3rem] text-[#195154] '>Earn gift cards just for shopping</div>
          <div className='text-[#524b4b] md:racking-wide text-center  text-[3.5vw] md:text-[1vw] my-[1vw] mx-auto md:w-[52%]'>
