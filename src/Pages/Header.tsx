                        ...
                        <div className='flex flex-col mx-auto cont2 items-center  md:gap-[7vw] xl:gap-[4.7rem]  relative md:-top-[10.7vw] xl:-top-[6.1rem]'>
                            ...
                            <div className='flex flex-col items-center justify-center gap-[0vw]'>
                                <div className='flex relative md:-top-[6vw]  md:-left-[0.3rem] justify-center items-center md:gap-[8rem] xl:gap-[12.4rem]'>
                                    ...
                                    <div className='md:relative xl:-top-[8rem] md:top-[13vw] items-center justify-center text-center flex text-center xl:-left-[0.5rem]'>
                                ...
                                <div className='flex md:relative xl:-top-[8.5rem] justify-center text-center items-center md:gap-[25rem] xl:gap-[30rem]'>
                                    ...
                                    <div className='absolute top-[72vw] xl:-top-[9.5rem] items-center justify-center flex text-center md:top-[5.3vw] xl:w-[400px] md:w-[70vw]'>
