...
export const Header = () => {
    ...
    return (
        <div>
            <div className='bg-[#edf1fe] mx-auto flex flex-col relative md:py-[3rem] xl:py-0 md:h-[100vh] xl:h-[78vh] w-screen cont'>
                {showNavbar && <Navbar />}
                <div className='xl:flex flex-col con text-center  justify-center'>
                    <div className='md:flex justify-between cont1 items-center md:px-[2.3rem] xl:py-[1.8vw] md:py-[0.8vw] relative '>
                    ...
                    <div className='flex flex-col items-center justify-center xl:-left-[1rem] relative'>
                        <div className='flex flex-col mx-auto cont2 items-center top-[] md:gap-[4.5rem]  relative md:-top-[9.7vw] xl:-top-[6.1rem]'>
                            <div className='text-center  cont3 xl:w-[43%] md:w-[80%] w-[90vw] text-[#212121] leading-[10vw] xl:leading-[3.3vw] md:leading-[10vw] flex relative md:my-[1vw] md:top-[8rem] xl:top-[7rem] md:scale-y-95 text-black font-medium tracking-[0.2px] xl:text-[3vw] md:text-[7.5vw]'>
                            ...
                            <div className='flex cont4 items-center xl:gap-[8vw] '>
                                ...
                                <div className='flex flex-col cont5 items-center justify-center xl:gap-[1vw] gap-[1vw] relative top-[3vw] md:top-[8vw] xl:-top-[2vw] no-wrap'>
                                    <div className='cont6'>
                                        <div className='text-center relative text-[#524b4b] xl:right-[1em]  xl:w-[65%] w-[87%] mx-auto text-[3.92vw] tracking-[0px] md:text-[3.4vw] xl:text-[1vw] font-normal'>
                                    ...
                                    <div className='flex flex-col relative xl:-left-[1rem] text-center  xl:text-[1vw] md:text-[4vw]  items-center justify-center xl:gap-[2px] gap-[2px] md:gap-[0.5rem]'>
                                        <div className='flex items-center text-center xl:text-[1vw] md:text-[4vw] justify-center gap-[8px]'>
                                            <div className='flex gap-[4px] xl:text-[1vw] md:text-[4vw]'>
                                                <FaStar color='#524b4b' size="14.5px" />
                                                <FaStar color='#524b4b' size="14.5px" />
                                                <FaStar color='#524b4b' size="14.5px" />
                                                <FaStar color='#524b4b' size="14.5px" />
                                                <FaStar color='#524b4b' size="14.5px" />
                                            ...
                                            <div className='flex flex-col items-center gap-[4px] font-bold'>
                                                <div className='flex items-center gap-[4px] font-bold xl:text-[1vw] md:text-[4vw]'>
                                                    <div className='text-[0.8rem] text-[#524b4b] xl:text-[1vw] md:text-[2.5vw]'>141,786 </div><div className='text-[0.8rem] font-light text-[#524b4b] xl:text-[1vw] md:text-[2.5vw]'>Chrome Store reviews</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className='flex gap-[0.15rem] items-center xl:text-[1vw] md:text-[4vw]'>
                            ...
                            <div className='flex flex-col items-center justify-center gap-[0vw]'>
                                ...
                                <div className='flex md:relative xl:-top-[8.5rem] justify-center text-center items-center md:gap-[25rem] xl:gap-[30rem]'>
                                    ...
                                    <div className='absolute top-[72vw] xl:-top-[9.5rem] items-center justify-center flex text-center xl:w-[400px]'>
