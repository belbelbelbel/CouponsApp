...
export const Navbar = () => {
    ...
    return (
        <div className='bg-white w-screen fixed z-20 py-[1rem]'>
            <div>
                <div className='flex items-center justify-between px-[2.5vw] h-[11vw] xl:px-[4rem] md:px-[3.5vw]'>
                    ...
                    <div className='flex items-center gap-[1rem] xl:gap-[4rem] md:gap-[2rem]'>
                        <button className='bg-orange-700 text-white  xl:w-[15vw] md:w-[40vw] w-[50vw] py-[3vw] text-[3vw] px-[1.1vw] md:py-[2.5vw]  xl:py-[0.7vw] rounded-[5px] hover:bg-orange-600'>Add to Chrome - it's Free</button>
                        <div className=''>
