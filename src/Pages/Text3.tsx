        ...
        <div>
            <div className='bg-[whitesmoke] w-screen py-[3.5rem]  text-black text'>
                <div className='flex py-[2rem] flex-col w-[91%] mx-auto  items-center relative -top-[0rem]'>
                    <div className='w-[80vw] md:w-[20vw]  max-h-[60vh] flex rounded-[100%] bg-transparent' >
                    ...
                    <div className='flex flex-col relative  -top-[0rem] md:-top-[0rem] gap-[0.7rem] md:gap-[0.5rem]'>
                        <div className='text-center  tracking-tight md:max-w-[100%]  max-w-[100%] mx-auto text-[5.5vw] md:text-[2.5vw] font-medium  md:leading-[3rem] text-[#195154] '>Apply coupons with a click</div>
                        <div className='text-[#524b4b] md:racking-wide text-center  text-[3.6vw] md:text-[1vw] my-[0vw] mx-auto md:w-[55%]'>
